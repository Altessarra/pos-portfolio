...
export default function POS() {
  ...
  return (
    <div>
      ...
      {receipt && <div className="mb-4 rounded-2xl bg-emerald-50 p-4 text-sm font-bold text-emerald-700">Checkout successful. Receipt: {receipt.receipt_no}</div>}
      ...
      <div className="grid gap-6 xl:grid-cols-[1fr_420px]">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
            {products.map(product => (
              <button
                ...
                className="rounded-3xl border border-slate-200 bg-white p-4 text-left transition hover:-translate-y-0.5 hover:shadow-soft disabled:opacity-50"
              >
        ...
        <aside className="card flex max-h-[calc(100vh-150px)] flex-col overflow-hidden">
